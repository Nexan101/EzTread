        ...
        <div className="w-full max-w-[420px]">
          <div className="bg-white rounded-3xl border border-[#d2d2d7] shadow-sm px-8 py-10">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="text-sm text-[#6e6e73] mt-1">Sign in to your EzTread account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label htmlFor="password" className="block text-[11px] font-bold text-[#6e6e73] uppercase tracking-wider">
                    Password
                  </label>
                  <Link href="#" className="text-[11px] font-medium text-[#f97316] hover:text-[#ea6b0f] transition-colors">
                    Forgot password?
                  </Link>
                </div>
            ...
            <div className="flex items-center gap-3 my-6">
              ...
              <span className="text-xs text-[#a1a1a6]">New to EzTread?</span>
              <div className="flex-1 h-px bg-[#e5e5ea]" />
            </div>
          ...
          <p className="text-center text-xs text-[#a1a1a6] mt-6">
            ...
            <Link href="/terms" className="underline underline-offset-2 hover:text-[#6e6e73]">Terms</Link>
            {" "}and{" "}
            <Link href="/privacy" className="underline underline-offset-2 hover:text-[#6e6e73]">Privacy Policy</Link>.
          </p>
        </div>
      </div>
    </div>
